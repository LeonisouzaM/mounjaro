                    ...
                    <div class="card-body" style="padding: 1.5rem 1.25rem;">
                        ...
                        <div class="payment-methods mt-4 text-center" style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 12px; max-width: 100%;">
                            <div style="display: flex; justify-content: center; align-items: center; gap: 14px; flex-wrap: wrap; margin-bottom: 8px;">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/4/41/Visa_Logo.png" alt="Visa" style="height: 16px; width: auto; display: block; object-fit: contain;">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/b/b7/MasterCard_Logo.svg" alt="Mastercard" style="height: 22px; width: auto; display: block; object-fit: contain;">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/American_Express_logo_%282018%29.svg" alt="Amex" style="height: 22px; width: auto; display: block; object-fit: contain;">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Diners_Club_Logo3.svg" alt="Diners Club" style="height: 20px; width: auto; display: block; object-fit: contain;">
                            </div>
                            <div style="display: flex; justify-content: center; align-items: center; gap: 14px; flex-wrap: wrap;">
                                ...
                                <img src="https://upload.wikimedia.org/wikipedia/commons/a/a2/OXXO_logo.svg" alt="OXXO" style="height: 20px; width: auto; display: block; object-fit: contain;">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/1/15/Pse_logo.svg" alt="PSE" style="height: 24px; width: auto; display: block; object-fit: contain;">
